...
namespace BountyCraftRazorApp.Models
{
    public class ItemModel : IItem
    {
        ...
        public ItemModel(string name, string realm, string mold_type, int mold_quantity, int stardust, string recipe, string alch1, int alch1qty, string alch2, int alch2qty)
        {
            this.Name = name;
            this.Realm = realm;
