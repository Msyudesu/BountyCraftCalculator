...
namespace BountyCraftLibraryTests
{
    public class InventoryTests
    {
        ...
        public void UpdateBountypointCostGivesCorrectAmount()
        {
            ...
            Inventory.Selections.Add(new Item("BC_Sword", "Seasonal", "Hibernia", "Weapon", 4, 5, "Curse", "Ancient Lich Tooth", 4, "Ancient Necrotic Brain Fluid", 4));
            Inventory.Selections.Add(new Item("BC_Hammer", "Seasonal", "Midgard", "Weapon", 2, 3, "Frozen", "Ancient Lich Tooth", 2 , "Ancient Necrotic Brain Fluid", 2));
            Inventory.Selections.Add(new Item("BC_Chest", "Seasonal", "Midgard", "Armor", 5, 5, "Otherworldly", "Ancient Lich Tooth", 2, "Ancient Necrotic Brain Fluid", 2));
